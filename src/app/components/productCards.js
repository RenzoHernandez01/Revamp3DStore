...
export default function ProductCards({ products = [], creators = null, filterMode = null }) {
  
    let filtered = products
    .filter(product => !filterMode || product.category.toLowerCase() === filterMode.toLowerCase())
    let sliced = filtered.slice(0,filtered.length)
    return (
