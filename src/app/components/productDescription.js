...
export default function productDescription({productName, sellerName, rating,totalRatingsBreakdown,productDescription}) {
  ...
  return (
  <div>
      <Stack direction={"row"} sx={{gap:0, display:"flex", alignItems:"center",marginBottom:2}}> 
       <Typography variant='h6' sx={{textDecoration:"underline", color:"black", marginRight:2}}>Product Description </Typography>
       <Typography variant='subtitle1' sx={{fontWeight:"bold",color:"black"}}>{rating}</Typography>
